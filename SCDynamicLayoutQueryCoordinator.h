...
- (id)initWithUserSession:(id)arg1 discoverFeedDataFetcher:(id)arg2 discoverFeedDataMutator:(id)arg3 eventsSessionProvider:(id)arg4 adsClientInfo:(id)arg5 dynamicLayoutUIBuilder:(id)arg6 discoverFeedEndpointManager:(id)arg7;
