...
- (void)_navigateToCameraWithMetadata:(id)arg1 publisherName:(id)arg2 deepLinkURL:(id)arg3 scanSource:(long long)arg4 publisherId:(id)arg5;
...
- (void)snapKitDeepLinkCard:(id)arg1 attachToSnapWithDeepLinkURL:(id)arg2 attachmentURLString:(id)arg3 attachmentShareMetadata:(id)arg4 publisherName:(id)arg5 scanSource:(long long)arg6;
