...
@class NSMutableDictionary, NSString, SCLazy, SCQueuePerformer, SCSendToRanker, SCSendToSnappableSnapchattersFetcher, SCSendToThisChatRecipientsFetcher, SCUserSession;
@protocol OS_dispatch_queue, SCGroupManager, SCSendToListsDataFetching, SCSnapchattersDataSearching;
...
- (id)initWithSnapchattersDataFetcher:(id)arg1 snapchattersSearchDataProvider:(id)arg2 snappableSnapchattersFetcher:(id)arg3 thisChatRecipientsFetcher:(id)arg4 listsDataFetcher:(id)arg5 snapchattersDataTracker:(id)arg6 groupManager:(id)arg7 groupsDataTracker:(id)arg8 userSession:(id)arg9;
