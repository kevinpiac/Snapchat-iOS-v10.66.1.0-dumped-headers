...
@class NSArray, NSString, SCCheckInOption, SCMetaSticker, SCStickerPickerCategoryCell, SCStickerPickerStickerCell, SCVenueInfoSticker, UICollectionView, UICollectionViewCell, UIGestureRecognizer, UIImage, UILongPressGestureRecognizer, UIScrollView, UIView;
