...
@interface SCSQLiteDocObjectContext : SCDocObjectContext <SCDiagnosableDocObjectContext, SCConflictingDocObjectContextDiagnosticInfo, SCDocObjectIndexBuilder>
{
    ...
    struct atomic<bool> _invalidated;
    struct atomic<unsigned long long> _changesTimestamp;
    ...
    struct atomic<unsigned long long> _observationToken;
    ...
    struct atomic<unsigned long long> _fetchedResultObservationToken;
