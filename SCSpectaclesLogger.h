...
- (void)logBoomboxSnapView:(id)arg1 entryId:(id)arg2 durationSec:(double)arg3 fileType:(long long)arg4 deviceId:(id)arg5 firmwareVersion:(id)arg6 hardwareVersion:(id)arg7 deviceColor:(long long)arg8 sessionId:(id)arg9;
- (void)logBoomboxStoryView:(id)arg1 durationSec:(double)arg2 numVideos:(unsigned long long)arg3 numPhotos:(unsigned long long)arg4 deviceId:(id)arg5 firmwareVersion:(id)arg6 hardwareVersion:(id)arg7 deviceColor:(long long)arg8 sessionId:(id)arg9;
