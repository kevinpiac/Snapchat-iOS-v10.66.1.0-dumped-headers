...
@interface SCDiscoverFeedManagementSettingFullScreenViewController : SIGSubscreenViewController <UICollectionViewDelegate, SCEventAnnouncing, SCSectionBasedCollectionViewUpdaterDelegate, UITextFieldDelegate>
{
