...
@class NSArray, NSString, SCOnDemandGeofilterDataController, SOJUUnlockablesOndemandAssetDraftList, SOJUUnlockablesOndemandAuthorizationFailure, SOJUUnlockablesOndemandCreateHomeFilterResponse, SOJUUnlockablesOndemandGetHomeFilterAssetResponse, SOJUUnlockablesOndemandGetHomeFilterResponse, SOJUUnlockablesOndemandInputValidationErrors, SOJUUnlockablesOndemandLineItem, SOJUUnlockablesOndemandOfferedInventory, SOJUUnlockablesOndemandPreRenderingAssetsStructuredResponse, SOJUUnlockablesOndemandStylizedTextList, SOJUUnlockablesOndemandTemplateCategoryList, SOJUUnlockablesOndemandUser;
