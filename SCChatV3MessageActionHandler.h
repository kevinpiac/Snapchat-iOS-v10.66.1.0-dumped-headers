...
- (id)initWithUsername:(id)arg1 conversationStore:(id)arg2 metadataStore:(id)arg3 sender:(id)arg4 conversationAPI:(id)arg5 mediaRequestManager:(id)arg6 mediaStateManager:(id)arg7 mediaReferenceManager:(id)arg8 snapViewVerifier:(id)arg9 messageStateHandler:(id)arg10 logger:(id)arg11 conversationManager:(id)arg12 userHelper:(id)arg13 storyLoader:(id)arg14 snapLogger:(id)arg15 fideliusManager:(id)arg16 lazyCustomStickerManager:(id)arg17 blockAssigner:(id)arg18 groupManager:(id)arg19 autoShakeToReporter:(id)arg20 contextPreloader:(id)arg21 mediaSendTaskManager:(id)arg22 usernameSnapchatterFetcher:(id)arg23 batchFetcher:(id)arg24 mediaExtensionCacheHandler:(id)arg25;
