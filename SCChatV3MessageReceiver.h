...
@interface SCChatV3MessageReceiver : NSObject <SCChatMessageReceiveListener, SCChatV3ConversationFetcherHandler, SCChatPrefetchResponseProcessing>
{
...
- (void)processPrefetchResponses:(id)arg1 completion:(CDUnknownBlockType)arg2;
